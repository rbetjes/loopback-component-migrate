...
module.exports = function(Migration, options) {
  ...
  Migration.migrationPrefix = options.migrationPrefix;
  debug('Migrations prefix set to: %s', Migration.migrationPrefix);
      ...
      if (filters.where) {
        filters.where = {
          and: [
            ...
            {
              name: {
                like: Migration.migrationPrefix + '%'
              }
            }
          ]
        };
